...
COMMON_INTERNAL_PORTS = [
    ...
    25,    # SMTP
    80,    # HTTP
    443,   # HTTPS / Kubernetes API (alternate)
    587,   # SMTP submission
    # Databases
    3306,  # MySQL
    5432,  # PostgreSQL
    5984,  # CouchDB (CVE-2017-12635 RCE)
    6379,  # Redis (CVE-2022-0543 RCE)
    9200,  # Elasticsearch REST API
    9300,  # Elasticsearch transport
    11211, # Memcached
    # Monitoring / dashboards
    3000,  # Grafana (CVE-2021-43798)
    # Web / app servers
    8080,  # HTTP alt / Jenkins
    8443,  # HTTPS alt / Jenkins / Kubernetes
    50000, # Jenkins CLI agent port
    ...
    2379,  # etcd client
    2380,  # etcd peer
    6443,  # Kubernetes API (default kubeadm)
    8500,  # HashiCorp Consul HTTP
    8501,  # HashiCorp Consul HTTPS
    # Messaging
    15671, # RabbitMQ management HTTPS
